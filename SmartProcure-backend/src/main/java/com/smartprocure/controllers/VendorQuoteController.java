...
public class VendorQuoteController {
	...
	public ResponseEntity<Resource> getQuotePdf(
	        @PathVariable Long quoteId) {

	    Resource resource = vendorQuoteService.getQuotePdf(quoteId);
	...
	@PostMapping("/{quoteId}/pdf")
	public ResponseEntity<ApiResponseDto> uploadQuotePdf(
			@PathVariable Long quoteId,
	        @RequestParam MultipartFile file) {

	    vendorQuoteService.uploadQuotePdf(quoteId, file);

	    return ResponseEntity.ok(
	            new ApiResponseDto(
	                    "Vendor Quote PDF uploaded successfully.",
	                    "Success"));
	}
